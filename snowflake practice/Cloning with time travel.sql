...
// Using time travel
SELECT * FROM OUR_FIRST_DB.public.time_travel at (OFFSET => -60*5);
...
SELECT * FROM OUR_FIRST_DB.public.time_travel_clone before (statement => '01bfda47-0001-66f5-000c-5be200047246');

CREATE OR REPLACE TABLE OUR_FIRST_DB.PUBLIC.time_travel_clone_of_clone
CLONE OUR_FIRST_DB.public.time_travel_clone before (statement =>'01bfda47-0001-66f5-000c-5be200047246');
